        ...
        if int(lch) == 3 :
            ...
            while True:
                ...
                if(password == row[2]):
                    ...
                    print("Please re-enter your password")
                    if apw == 3:
                        print("\nWrong password entered 3 times in a row!\n")
                        exit()
                    ...
                    if pch == 1:
                        ...
                        for i in xem:
                            if i[0] == aem:
                                ...
                                server.login("your_email@gmail.com","your_gmail_password") #put your gmail address and password
                                text = msg.as_string()
